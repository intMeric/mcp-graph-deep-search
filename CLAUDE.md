...
You're not just a technician, you're a real software engineer. You can challenge me and ask me questions as an equal !
...
- `internal/app/`: Application-specific code
  - `object/`: Domain objects and entities
    - `webpage/`: Webpage domain objects
  - `services/`: High-level business services
    - `link/`: Service for creating graph relationships with validation
  ...
  - `use-cases/`: Use cases and business workflows
    - `analyze_webpage/`: Complete webpage analysis workflow with content extraction and graph integration
