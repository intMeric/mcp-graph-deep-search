...
type smartDocumentRetrievalUseCase struct {
	database              database.Database
	analyzeWebpageUseCase analyze_webpage.AnalyzeWebpageUseCase
}

func NewSmartDocumentRetrievalUseCase(
	db database.Database,
	analyzeWebUC analyze_webpage.AnalyzeWebpageUseCase,
) SmartDocumentRetrievalUseCase {
	return &smartDocumentRetrievalUseCase{
		database:              db,
		analyzeWebpageUseCase: analyzeWebUC,
	}
}

func (uc *smartDocumentRetrievalUseCase) Execute(ctx context.Context, req *SmartDocumentRetrievalRequest) (*SmartDocumentRetrievalResponse, error) {
	if req == nil {
	...
	response := &SmartDocumentRetrievalResponse{
		Node: req.Node,
	}
